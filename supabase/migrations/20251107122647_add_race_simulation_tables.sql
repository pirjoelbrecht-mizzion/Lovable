/*
  # Race Mode Simulation - Database Schema

  1. New Tables
    - `race_simulations`
      - Stores race simulation predictions and history
      - Links to races and users
      - Includes all prediction factors (terrain, elevation, climate, fatigue)
      - Tracks confidence scores and readiness
    - `readiness_scores`
      - Daily readiness tracking (0-100 scale)
      - Stores component breakdown (recovery, freshness, sleep, HRV, fatigue)
      - Supports manual inputs and multi-source data (Garmin, Oura, etc)
      
  2. Security
    - Enable RLS on both tables
    - Users can only access their own simulations and readiness scores
  ...
  3. Features
    ...
    - Ready for wearable integrations
*/
